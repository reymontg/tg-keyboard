...
abstract class RequestButton extends KeyboardButton
{
    public function __construct(string $text, protected int $buttonId, Color $color = Color::NONE, ?int $emojiId = null)
    {
