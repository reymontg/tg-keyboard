...
final class RequestChannel extends RequestPeer
{
     ...
     */
    public function __construct(string $text, int $buttonId, private ?bool $creator = null, private ?bool $hasUsername = null, private ?bool $member = null, bool $name = false, bool $username = false, bool $photo = false, private ?AdministratorRights $userAdminRights = null, private ?AdministratorRights $botAdminRights = null, Color $color = Color::NONE, ?int $emojiId = null)
    {
     ...
     * @param ?int                 $emojiId         Unique identifier of the custom emoji shown before the text of the button. Can only be used by bots that purchased additional usernames on [Fragment](https://fragment.com/) or in the messages directly sent by the bot to private, group and supergroup chats if the owner of the bot has a Telegram Premium subscription.
     */
    public static function new(string $text, $buttonId, ?bool $creator = null, ?bool $hasUsername = null, ?bool $member = null, bool $name = false, bool $username = false, bool $photo = false, ?AdministratorRights $userAdminRights = null, ?AdministratorRights $botAdminRights = null, Color $color = Color::NONE, ?int $emojiId = null): self
    {
        return new static($text, $buttonId, $creator, $hasUsername, $member, $name, $username, $photo, $userAdminRights, $botAdminRights, $color, $emojiId);
    }
